...
<html lang="en">
  ...
  <body>
    <h1>Courses and Students Enrolled</h1>
...
$sql = "SELECT courseid,description,prefix,number from course";
...
?>
   <div class="card">
    <div class="card-body">
      <h5 class="card-title"><?=$row["description"]?><?=$row["prefix"]?><?=$row["number"]?></h5>
