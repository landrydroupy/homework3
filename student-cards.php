...
<html lang="en">
  ...
  <body>
    <h1>Students and Enrolled Courses</h1>
...
<?php
    $section_sql = "select c.description,c.courseid,s.courseid from from student s join course c on s.courseid = c.courseid where s.courseid=" . $row["courseid"];
